...
func (r *SushrutAWSManagerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	awsManager := &awsv1.SushrutAWSManager{}
...
func (r *SushrutAWSManagerReconciler) DeploymentForAWSManager(ctx context.Context, req ctrl.Request, awsManager *awsv1.SushrutAWSManager) *appsv1.Deployment {
	...
	log := ctrllog.FromContext(ctx)
	log.Info("Inside DeploymentForSushrutAWSManager")
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					...
					Containers: []corev1.Container{{
						...
						ImagePullPolicy: awsManager.Spec.ImagePullPolicy,
					}}, // Container
					RestartPolicy: awsManager.Spec.RestartPolicy,
				}, // PodSec
			}, // PodTemplateSpec
		}, // Spec
	} // Deployment
